...
router.post("/deleteIntern",verifyToken,authUser("admin","team leader"),authTeamLeader(),deleteInternController,authUser("admin","team leader"),authTeamLeader(),deleteInternController)
